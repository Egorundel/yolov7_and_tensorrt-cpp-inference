...
- split the file .json for three files .json
  ...
  - to do this, install pyodi into the system by typing in the terminal ```shell pip install pyodi```
  - and run the following code in the terminal first once: ```shell pyodi coco random-split ./*YOUR_PATH_TO_JSON*.json ./random_coco_split --val-percentage 0.1```
