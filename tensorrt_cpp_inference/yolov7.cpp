...
int main()
{
	 ...
	 */
	if (mode == "video") {
		std::string video_filepath = "../samples_video/video4.avi";
		...
		cv::VideoWriter output_video("output2.mp4", cv::VideoWriter::fourcc('H', '2', '6', '4'), fps, frame_size);
	 ...
	 */
		...
		cv::String pattern = "../samples_images/*.png";
